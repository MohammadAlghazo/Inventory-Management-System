...
export class DashboardComponent implements OnInit {
  ...
  get kpis() {
    return [
      ...
      { label: 'DASHBOARD.ITEMS_OUT',      value: (this.statsObj.todayMovements || 0).toLocaleString(),       icon: this.icons.Activity,      color: '#ef4444', bg: 'rgba(239, 68, 68, 0.12)',  route: '/inventory' },
    ];
  }
