    ...
    public class UserService : IUserService
    {
        ...
        public async Task<ApiResponse<PagedResult<UserProfileDto>>> GetAllUsersAsync(int page, int pageSize, string? search)
        {
            ...
            var items = await q
                ...
                .Select(u => new UserProfileDto
                {
                    ...
                    LastName       = u.LastName,
                    Role           = u.Role != null ? (u.Role.Name == "Manager" ? "SuperAdmin" : (u.Role.Name == "Employee" ? "WarehouseStaff" : u.Role.Name)) : "Employee",
        ...
        public async Task<ApiResponse<UserProfileDto>> UpdateUserAsync(int id, UpdateUserDto dto)
        {
            ...
            return ApiResponse<UserProfileDto>.Ok(new UserProfileDto
            {
                ...
                FirstName      = user.FirstName,
                LastName       = user.LastName,
                Role           = user.Role != null ? (user.Role.Name == "Manager" ? "SuperAdmin" : (user.Role.Name == "Employee" ? "WarehouseStaff" : user.Role.Name)) : "Employee",
                IsAdmin        = user.RoleId == 1 || user.RoleId == 2,
                IsActive       = user.IsActive,
                ProfilePicture = user.ProfilePicture,
                CreatedAt      = user.CreatedAt
